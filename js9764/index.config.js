...
var index_config_base_default = {
  ...
  danmu: {
    urls: [
           { address: "https://danmuapi-ten-iota.vercel.app", name: "默认1" },
           { address: "https://fjj0417.dpdns.org/87654321", name: "默认2" }, 
           { address: "https://dm.stardm.us.kg:443/87654321", name: "默认3" }, 
           { address: "https://danmu.xyzd.eu.org/87654321", name: "默认4" }, 
           { address: "https://danmu.14812910.xyz/87654321", name: "默认5" }, 
           { address: "https://313236.xyz/87654321", name: "默认6" }
          ],
    autoPush: true
  },
  //排序
  order: ["baidu", "tyi", "quark", "uc", "yd", "pan123", "ali", "y115"],
  //网盘
  uc: {
    enable: true,
    prefix: "UC",
  ...
  //模板
  template: [
    { siteName: "lbpp", displayName: "蜡笔", defaultUrl: "http://feimao888.fun" },
    ...
    { siteName: "xiaomi", displayName: "小米", defaultUrl: "https://www.zhizhenpan.fun/" },
    { siteName: "xiaoban", displayName: "小斑", defaultUrl: "http://xsayang.fun:12512" }
  ],
  //网站
  age: {
    url: ""
  ...
  tgsou: {
    url: "https://tgsou.252035.xyz",
    count: 1,
    pic: false,
    channelUsername: "wydwpzy,zyywpzy,sgkwpzy,yunpanuc,skywpzy"
  },
  tgchannel: {
    ...
    pic: true,
    channelUsername: "wydwpzy,zyywpzy,sgkwpzy,yunpanuc,skywpzy",
    homeChannelUsername: "wydwpzy,zyywpzy,sgkwpzy,yunpanuc,skywpzy"
  },
  //alist
  alist: [
    {
